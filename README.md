...
* A second script (MPCTree.py) to calculate the maximum parent credibility (MPC) transmission tree from the extra .net file that ModifyXML.py makes BEAST produce (which logs the transmission tree).
