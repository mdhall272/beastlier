 ...
 */
public class ElementTraitSetInputEditor extends InputEditor.Base {
    ...
    public void init(Input<?> input, BEASTInterface plugin, int itemNr, ExpandOption bExpandOption, boolean bAddButtons) {
        ...
        tableModel = new ElementTraitTableModel(traitSet);
        JTable table = new JTable(tableModel);

        JButton guessButton = new JButton("Guess");
        guessButton.addActionListener((ActionEvent e) -> {
            GuessPatternDialogBEASTLIER dlg = new GuessPatternDialogBEASTLIER(null,
                ".*(\\d\\d\\d\\d).*", "Taxon_ID", "Case_ID");
            
            String traitString = "";
            switch(dlg.showDialog("Guess case IDs")) {
                case canceled:
                    return;
                case trait:
            ...
            try {
                ...
                System.err.println("Error setting element trait.");
            }
            refreshPanel();
        });
    ...
    class ElementTraitTableModel extends AbstractTableModel {

        TraitSet typeTraitSet;

        public ElementTraitTableModel(TraitSet typeTraitSet) {
