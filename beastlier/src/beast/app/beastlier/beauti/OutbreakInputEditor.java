 ...
 */
public class OutbreakInputEditor extends InputEditor.Base {
    ...
    public void init(Input<?> input, BEASTInterface plugin, int itemNr, ExpandOption bExpandOption, boolean bAddButtons) {
        ...
        tableModel = new OutbreakTableModel(traitSet);
    ...
    class OutbreakTableModel extends AbstractTableModel {

        TraitSet typeTraitSet;

        public OutbreakTableModel(TraitSet typeTraitSet) {
